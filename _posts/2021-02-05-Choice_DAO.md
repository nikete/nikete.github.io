...
* Wed Mar 17 2021 17:42:39 GMT-0700 (PDT)
* Source doc: An Experiment in Mechanism Design for Decision Advice
----->



# **CHOICE: a protocol for good advice.**
...
_Advice Auctions_ may be the mechanism that enables market driven decision making. It is based on an old and simple idea, giving your advisors a share of the reward, with a algorithmic twist of facilitating the advisors themselves seeking advice in the same way. 
